...
(function(t) {
    ...
    var o = t.document, r = [];
    e.isReady = !1, t.docReady = n(t.eventie)
}(this), function() {
    function t() {
    }
    function e(t, e) {
    ...
    "function" == typeof define && false && define.amd ? define(["classie/classie", "get-size/get-size", "outlayer/outlayer", "packery/js/rect", "packery/js/packer", "packery/js/item"], e) : t.Packery = e(t.classie, t.getSize, t.Outlayer, t.Packery.Rect, t.Packery.Packer, t.Packery.Item)
}(window);
